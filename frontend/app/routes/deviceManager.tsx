...
export default function Index() {
  ...
  return (
    <div className="w-full p-6 h-screen overflow-auto bg-gray-100">
        <div className='bg-gray-100 overflow-auto' style={{height:'90vh'}}>
        ...
        <div className='flex justify-end items-center h-12'>
            <button className='bg-lime-400 w-24 h-14 rounded-3xl text-white text-xl border-2 shadow-sm hover:bg-lime-800 shadow-lime-600 hover:pointer' 
